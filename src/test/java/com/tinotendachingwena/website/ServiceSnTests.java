...
public class ServiceSnTests {
    ...
    public void testSuccessfulServiceRequest() throws Exception {
        ...
        this.mockMvc.perform(post("/sn/service").contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE)
                ...
                content().string(not(Matchers.containsString("Date can not be empty"))),
                content().string(not(Matchers.containsString("Date has been tampered with"))),
                content().string(Matchers.containsString(StringResources.goodServicesRequestSn)));
    }
    ...
    public void testRateLimiting() throws Exception {
        ...
        for (int i = 0; i < 5; i++){
            this.mockMvc.perform(post("/sn/service").contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE)
                    ...
                    content().string(StringResources.goodServicesRequestSn));
        }
        this.mockMvc.perform(post("/sn/service").contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE)
